...
BASE = r"E:\JupyterPjs\MOF_SynBench\ActMOF_Workshop"
OUTDIR = os.path.join(BASE, "figures", "followup")

err = pd.read_csv(os.path.join(BASE, "Error_data.csv"))
...
fig.savefig(os.path.join(OUTDIR, "today_summary_dashboard.png"), dpi=170, bbox_inches="tight")
plt.close(fig)
print("Saved:", os.path.join(OUTDIR, "today_summary_dashboard.png"))
