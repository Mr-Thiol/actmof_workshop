...
fig.savefig(os.path.join(OUTDIR, "priority_pairs_scatter_labeled.png"), dpi=160, bbox_inches="tight")
plt.close(fig)
...
corr_df.to_csv(os.path.join(OUTDIR, "correlations_noncatastrophic.csv"), index=False)
